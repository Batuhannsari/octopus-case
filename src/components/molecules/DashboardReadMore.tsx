    ...
    return (
        ...
        <div className="flex flex-wrap">
            ...
            <div className="flex justify-center w-full lg:w-5/12   bg-white p-4 rounded-2xl  ">
                ...
                <div className='w-full bg-cover bg-no-repeat bg-center rounded-xl p-5' style={{ maxWidth: "619px", height: "255px", background: "linear-gradient(to top, rgba(49, 56, 96, .1), #151928) ,url('/dashboardImage.png')" }}>
                    <div className='flex flex-col h-full max-w-sm justify-between'>
                        ...
                        <div className='cursor-pointer flex flex-row gap-1'>
                            <Typography style={{ fontSize: "10px" }} className='text-white font-bold'>Read more</Typography>
